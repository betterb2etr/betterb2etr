...
#### MURE : 뮤지컬 예매 티켓팅 알람 앱

타 공연 분야 대비 공연에 대한 공지 시스템이 불편한, 뮤지컬 덕질의 편의를 증진시키기 위한 모바일 앱  

5명의 팀원, 동아리 내부 팀플

BE2, FE2, Design1 구성

nodeJS,AWS EC2, RDS, prisma, mySQL활용 
...
교내 동아리 내부 커뮤니케이션 강화를 위해 기획·개발한 동아리 전용 디스코드형 커뮤니티 플랫폼

Spring Boot 기반 ,서버 환경 구축 및 API 개발

**BE / Java, Spring Boot, MySQL, MongoDB, GitHub
...
당시 동아리내에서 철권7이 유행, 비효율적으로 오프라인으로 대결 신청 후 티어표 갱신하는 모습에서 좀 더 게임 유저들의 편의성을 높이기위해 제작
...
JAVA로 GUI를 구현하고, 구현한 GUI를 기반으로 mySQL를 조작 가능하도록 구현
...
타 회사들의 기술블로그들을 모티브로, 자바스크립트를 기반으로 웹형식의 동아리 자체의 기술블로그 제작
...
파이썬으로 동아리 내에서 유용하게 쓰이는 디스코드내에서 사용될 챗봇 제작. 디자이너로 배정 받음
